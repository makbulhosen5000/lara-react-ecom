...
export default function Product() {
  return (
    <>
    <Helmet>
          <title>MakbulAgro||Product</title>
    </Helmet>
    <section  className="bg-gray-200 mt-5">
        <div className="container mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold underline">Products</h2>
                    ...
                    <div className=" max-w-sm mx-auto bg-white/70 backdrop-blur-md border border-gray-200  shadow-lg overflow-hidden ">
                        <div>
                            ...
                            <div className='p-1'>
                                ...
                                <div>
                                    <input type="checkbox" name="guava" />  
                                    <label> Guava</label>                        
                                </div>
                                <div>
                                    <input type="checkbox" name="hens" />  
                                    <label> Hens</label>                        
                                </div>
                                <div>
